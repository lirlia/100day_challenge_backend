        ...
        <div className="space-y-4">
          <div className="flex items-center">
            <input
              ...
              disabled={isApplying}
            />
            <label htmlFor="nosniffEnabled" className="ml-2 block text-sm text-gray-300">
      ...
      <div className="mt-8 p-6 bg-gray-800 rounded-lg shadow-md">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="border border-dashed border-gray-600 rounded-md p-4">
            ...
            <p className="text-xs text-gray-500 mb-2">サーバーは <code>Content-Type: image/jpeg</code> と共にHTML文字列 (<code>&lt;h1&gt;HTMLです&lt;/h1&gt;</code>) を返します。</p>
            <iframe
          ...
          <div className="border border-dashed border-gray-600 rounded-md p-4">
            ...
            <p className="text-xs text-gray-500 mb-2">サーバーは <code>Content-Type: text/plain</code> と共にJavaScriptコード (<code>alert('Script executed as text!')</code>) を返します。</p>
        ...
        <p className="text-xs text-gray-500 mt-4">注意: 実際のMIMEスニッフィングの挙動はブラウザの種類やバージョンによって異なる場合があります。</p>
      </div>
    </div>
  );
}
