      ...
      <div className="mt-8 p-6 bg-gray-800 rounded-lg shadow-md">
        ...
        <div className="prose prose-sm prose-invert max-w-none text-gray-300 space-y-3">
          ...
          <ul>
            ...
            <li>ローカル開発環境 (http://localhost) では、通常ブラウザはHSTSを適用しません。HSTSの完全な動作を確認するには、mkcertなどでローカルHTTPS環境を構築し、自己署名証明書を信頼させる必要があります。このプレイグラウンドでは、主にHTTPレスポンスヘッダーに <code>Strict-Transport-Security</code> が正しく設定されるかを確認します。</li>
