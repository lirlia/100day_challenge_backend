...
export default function NeumorphicInput({ className = '', ...props }: NeumorphicInputProps) {
  return (
    <input
      className={`w-full px-4 py-3 rounded-neumorphism bg-neumorphism-bg text-neumorphism-text shadow-neumorphism-input
                 focus:outline-none focus:ring-1 focus:ring-neumorphism-accent
                 dark:bg-neumorphism-bg-dark dark:text-neumorphism-text-dark dark:shadow-neumorphism-input-dark
