...
**🚨 2025/06/19 更新**: 重大バグを修正し、残高計算システムが正常に動作するようになりました。Bitcoin標準準拠のRIPEMD160ハッシュ実装により、Genesis ウォレットの50BTC報酬が正確に表示されます。
...
### 🔧 重大バグ修正
- **残高計算システム修正**: Genesis ウォレットの50BTC報酬が正確に表示されるように
- **HashPubKey関数改善**: SHA256単体から標準的なSHA256+RIPEMD160実装へ変更
- **APIサーバー安定化**: スライス範囲外アクセスエラーの完全な排除

### ✅ 修正結果
- Genesis ブロック報酬: **50BTC (5,000,000,000 satoshi)** の正確な残高表示
- Bitcoin標準準拠: **20バイト RIPEMD160 ハッシュ** によるアドレス生成
- システム安定性: API クラッシュの根本的解決
